...
// when Google Translate wraps or mutates text nodes in the DOM.
...
export function isHindiActive(): boolean {
  ...
  try {
    const saved = localStorage.getItem("lubricon_language");
...
export function changeLanguage(lang: "EN" | "HI") {
  ...
  try {
    localStorage.setItem("lubricon_language", lang);
  } catch {}
